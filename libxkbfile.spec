...
Version  : 1.1.2
Release  : 16
URL      : https://www.x.org/releases/individual/lib/libxkbfile-1.1.2.tar.gz
Source0  : https://www.x.org/releases/individual/lib/libxkbfile-1.1.2.tar.gz
Source1  : https://www.x.org/releases/individual/lib/libxkbfile-1.1.2.tar.gz.sig
...
%prep
%setup -q -n libxkbfile-1.1.2
cd %{_builddir}/libxkbfile-1.1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670530049
